...
fn transfer_sol() {
    ...
    match sig.verify(&pubkey.to_bytes(), sig_hashed) { 
        true => println!("Signature verified"), 
        false => println!("Verification failed"), 
    }
    let to_pubkey = Pubkey::from_str("CQs18dEF514FtuQXvkYhkMJj6Hyawzekk5SwFwj2HGFv").unwrap();
...
fn transfer_all_sol() {
    ...
    println!( 
    "Success! Entire balance transferred: https://explorer.solana.com/tx/{}/?cluster=devnet", signature); 
}
